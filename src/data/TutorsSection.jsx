export const tutorsSection = {
    content:` <p className="deskripsi">Tutorial Membuat Website</p>
    <h2>Tutors</h2>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias deleniti a ab sint vel ut quod harum sequi! Fugiat, nemo.</p>`
}
